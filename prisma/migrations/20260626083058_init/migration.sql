...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('flight', 'transport', 'lodging', 'activity');

-- CreateEnum
CREATE TYPE "SplitType" AS ENUM ('equal', 'exact', 'percentage');

-- CreateEnum
CREATE TYPE "PinType" AS ENUM ('image', 'link', 'note');

-- CreateEnum
CREATE TYPE "ExpenseCategory" AS ENUM ('food', 'transport', 'lodging', 'activities', 'shopping', 'other');
...
CREATE TABLE "CanvasPin" (
    ...
    CONSTRAINT "CanvasPin_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "TripMember_tripId_userId_idx" ON "TripMember"("tripId", "userId");
...
-- CreateIndex
CREATE INDEX "TripInvite_token_idx" ON "TripInvite"("token");
...
-- AddForeignKey
ALTER TABLE "TripInvite" ADD CONSTRAINT "TripInvite_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_linkedActivityId_fkey" FOREIGN KEY ("linkedActivityId") REFERENCES "Activity"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CanvasPin" ADD CONSTRAINT "CanvasPin_tripId_fkey" FOREIGN KEY ("tripId") REFERENCES "Trip"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CanvasPin" ADD CONSTRAINT "CanvasPin_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
